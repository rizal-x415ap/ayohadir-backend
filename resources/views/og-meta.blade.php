...
<head>
    ...
    <meta property="og:image:width" content="{{ str_contains($image, 'amplope.png') ? '350' : '1200' }}">
    <meta property="og:image:height" content="{{ str_contains($image, 'amplope.png') ? '293' : '630' }}">
